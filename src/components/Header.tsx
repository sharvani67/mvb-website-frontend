...
//       {/* MOBILE MENU */}
//       <div
//   className={`md:hidden fixed top-20 right-0 h-[80vh] w-1/2 transition-all duration-300 ${
//     mobileOpen ? 'translate-x-0' : 'translate-x-full'
//   } bg-white/95 backdrop-blur-xl shadow-2xl border-l border-gray-200 overflow-y-auto`}
// >
