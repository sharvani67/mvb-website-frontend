...
//       <div id="jobs-section" ref={openingsRef} className="max-w-6xl mx-auto px-4 py-12">
//         {/* Search and Filter */}
//         <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
//           <div className="flex flex-col md:flex-row gap-4">
//             <div className="flex-1 relative">
...
//                     {/* Buttons for Featured Jobs - Apply Now and View Details */}
...
//   onClick={() => setSelectedJob(job)}
//   variant="outline"
//   className="border-pink-600 text-pink-600 hover:bg-pink-50 hover:!text-black"
// >
//   View Details
// </Button>
//                     </div>
...
//                         <div className="flex flex-wrap gap-3">
//                           <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs">
//                             <Briefcase className="h-3 w-3"/> <span className="capitalize">{job.department}</span>
//                           </span>
//                           <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs">
//                             <MapPin className="h-3 w-3" /> {job.location}
//                           </span>
//                           <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs">
//                             <Clock className="h-3 w-3" /> <span className="capitalize">{job.type}</span>
//                           </span>
//                           <span className="inline-flex items-center gap-1 px-2 py-1 bg-gray-100 text-gray-700 rounded-md text-xs">
//                             <GraduationCap className="h-3 w-3" /> <span className="capitalize">{job.experience}</span>
//                           </span>
//                         </div>
//                       </div>
//                       <div className="flex gap-3">
...
//               <div className="flex flex-wrap gap-3 mb-6 pb-4 border-b">
//                 <span className="inline-flex items-center gap-1 px-3 py-1 bg-pink-100 text-pink-700 rounded-full text-sm">
//                   <Briefcase className="h-4 w-4" /> <span className="capitalize">{selectedJob.department}</span>
//                 </span>
//                 <span className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">
//                   <MapPin className="h-4 w-4" /> {selectedJob.location}
//                 </span>
//                 <span className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">
//                   <Clock className="h-4 w-4" /> <span className="capitalize">{selectedJob.type}</span>
//                 </span>
//                 <span className="inline-flex items-center gap-1 px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm">
//                   <GraduationCap className="h-4 w-4" /> <span className="capitalize">{selectedJob.experience}</span>
//                 </span>
//                 {selectedJob.salary_range && (
//                   <span className="inline-flex items-center gap-1 px-3 py-1 bg-green-100 text-green-700 rounded-full text-sm">
//                     <DollarSign className="h-4 w-4" /> {selectedJob.salary_range}
...
const CareersPage = () => {
 ...
 const fetchDepartments = async () => {
  ...
  const validateForm = () => {
    ...
    } else if (!/^\d+\s*-\s*\d+\s*years?$|^\d+\+?\s*years?$|^\d+$/.test(formData.experience.toLowerCase())) {
      errors.experience = "Please enter valid experience (e.g., '3-5 years', '5+ years', or '3')";
    }
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent`}
                    />
                    {formErrors.fullName && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border ${formErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent`}
                    />
                    {formErrors.email && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border ${formErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent`}
                    />
                    {formErrors.phone && (
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border ${formErrors.experience ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 focus:ring-2 focus:ring-pink-500 focus:border-transparent`}
                    />
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        accept=".pdf,.doc,.docx"
                        onChange={handleResumeChange}
                        className={`flex-1 border ${formErrors.resume ? 'border-red-500' : 'border-gray-300'} rounded-lg p-2 focus:ring-2 focus:ring-pink-500`}
                      />
                      <Upload className="h-5 w-5 text-gray-400" />
                    </div>
                    <p className="text-xs text-gray-500 mt-1">Max file size: 5MB</p>
